...
Course_title2,Section2,Examination2,Final2 FROM insert_database ORDER BY Student_ID";
...
<br>
	...
	<div class="row">
		...
		<div class="col-12 col-sm-6" id="rt">
		<?php if (isset($_SESSION['username'])) : ?>
				<p >Login by :  <strong><?php echo $_SESSION['username']; ?></strong></p>
				<p><a href="read_table_admin.php?logout='1'"class="btn btn-danger" >Logout</a></p>
			<?php endif ?>
		</div>
	...
	<div class="row"> 
		<div class="col-12 ">
		<h2>View all data in database</h2>
		</div>	
	</div>


<form method="POST" action="form.php">
	<input type="Submit" class="btn btn-info" value="Add New data" />
</form>
<br>
<table border="3" class="table table-primary table-striped" >
<tr align="center">
	<th>Student_ID</th>	
	<th>School</th>
	<th>GPAX</th>
